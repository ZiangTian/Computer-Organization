...
HD_PWD='E:/One Drive/OneDrive - whu.edu.cn/Learning/computerOrg/lab_related/project_0/project_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tmpfile.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tmpfile.tcl -notrace
