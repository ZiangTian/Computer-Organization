...
HD_PWD='E:/One Drive/OneDrive - whu.edu.cn/Learning/computerOrg/lab_related/project_0/project_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tmpfile.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tmpfile.tcl
