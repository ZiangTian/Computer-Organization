...
begin
  ...
  spo(27) <= \^spo\(28);
  spo(26 downto 1) <= \^spo\(26 downto 1);
  spo(0) <= \^spo\(1);
...
\synth_options.dist_mem_inst\: entity work.ROM_D_dist_mem_gen_v8_0_12_synth
     port map (
      ...
      spo(25 downto 0) => \^spo\(26 downto 1)
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
