set_property SRC_FILE_INFO {cfile:{E:/One Drive/OneDrive - whu.edu.cn/Learning/computerOrg/lab_related/Computer-Organization/advanced/icf-v-p.xdc} rfile:../../../../../../advanced/icf-v-p.xdc id:1} [current_design]
