...
HD_PWD='E:/One Drive/OneDrive - whu.edu.cn/Learning/computerOrg/lab_related/Computer-Organization/coursecodes/day3/Single_CPU/Single_CPU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_SCPU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_SCPU.tcl
