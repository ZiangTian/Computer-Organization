...
HD_PWD='E:/One Drive/OneDrive - whu.edu.cn/Learning/computerOrg/lab_related/Computer-Organization/coursecodes/day3/Single_CPU/Single_CPU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_SCPU.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_SCPU.tcl -notrace
